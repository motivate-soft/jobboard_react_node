      ...
      >
        <div className="absolute inset-0 overflow-hidden">
          ...
          <div className="fixed inset-y-0 right-0 pl-10 max-w-full flex sm:pl-16">
            ...
            >
              <div className="w-screen max-w-2xl relative">
                <form
                    ...
                    <div className="relative py-6 space-y-6 sm:py-0 sm:space-y-0 sm:divide-y sm:divide-gray-200 border-2 border-gray-200 rounded-md">
                      ...
                      <div className="space-y-1 px-4 sm:space-y-0 flex flex-col sm:gap-4 sm:px-6 sm:py-5">
                        ...
                        <div className="flex flex-col">
                          ...
                          <span className="text-xs">
                            Your company's brand/trade name: without Inc., Ltd.,
                            B.V., Pte., etc.
                          </span>
                        </div>
                      </div>
                      ...
                      <div className="space-y-1 px-4 sm:space-y-0 flex flex-col sm:gap-4 sm:px-6 sm:py-5">
                        ...
                        <div className="flex flex-col">
                          ...
                          <span className="text-xs">
                            Please specify as single job position like
                            "Marketing Manager" or "Node JS Developer", not a
                            sentence like "Looking for PM / Biz Dev / Manager".
                            We know your job is important but please DO NOT
                            WRITE IN FULL CAPS. If posting multiple roles,
                            please create multiple job posts. A job post is
                            limited to a single job. We only allow real jobs,
                            absolutely no MLM-type courses "learn how to work
                            online" please.
                          </span>
                        </div>
                      </div>
                      ...
                      <div className="space-y-1 px-4 sm:space-y-0 flex flex-col sm:gap-4 sm:px-6 sm:py-5">
                        ...
                        <div className="flex flex-col">
                          ...
                          <span className="text-xs">
                            This primary tag shows first and increases
                            visibility in the main sections. Your job is shown
                            on every page that is tagged with though. E.g. if
                            you tag it as PHP, it shows for Remote PHP Jobs etc.
                          </span>
                        </div>
                      </div>
                      ...
                      <div className="space-y-1 px-4 sm:space-y-0 flex flex-col sm:gap-4 sm:px-6 sm:py-5">
                        ...
                        <div className="flex flex-col">
                          ...
                          <span className="text-xs">
                            Short tags are preferred. Use tags like industry and
                            tech stack, and separate multiple tags by comma. The
                            first 3 or 4 tags are shown on the site, the other
                            tags aren't but the job will be shown on each tag
                            specific page (like /remote-react-jobs). We also
                            generate tags automatically after you post/edit to
                            supplement.
                          </span>
                        </div>
                      </div>
                      ...
                      <div className="space-y-1 px-4 sm:space-y-0 flex flex-col sm:gap-4 sm:px-6 sm:py-5">
                        ...
                        <div className="flex flex-col">
                          ...
                          <span className="text-xs">
                            ...
                            location or timezone this remote job is restricted
                            to (e.g. Europe, United States or CET Timezone). If
                            not restricted, please leave it as "Worldwide". The
                            less restricted this is, the more applicants you
                            will get. Keeping it "Worldwide" is highly
                            recommended as you'll have access to a worldwide
                            pool of talent. To promote fairness in remote work
                      ...
                      <div className="space-y-1 px-4 sm:space-y-0 flex flex-col sm:gap-4 sm:px-6 sm:py-5">
                        <div>
                          <label className="block font-bold text-lg uppercase text-gray-900 sm:mt-px sm:pt-2">
                            ANNUAL SALARY OR COMPENSATION IN USD (OR ANNUALIZED,
                            IN USD EQUIVALENT)*
                          </label>
                        </div>
                      ...
                      <div className="space-y-1 px-4 sm:space-y-0 flex flex-col sm:gap-4 sm:px-6 sm:py-5">
                        <div>
                          <label
                            ...
                            className="block font-bold text-lg uppercase text-gray-900 sm:mt-px sm:pt-2"
                          >
                            COMPANY EMAIL* (STAYS PRIVATE, FOR INVOICE + EDIT
                            LINK)
                          </label>
                        </div>
                        <div>
