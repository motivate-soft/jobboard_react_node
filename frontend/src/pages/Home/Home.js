...
export default function Home() {
  ...
  return (
    <div className="relative flex h-screen">
      <button
        type="submit"
        className="mb-auto inline-flex font-sans justify-center py-2 px-4 border border-transparent shadow-sm text-lg font-medium rounded-md text-white bg-indigo-500 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
